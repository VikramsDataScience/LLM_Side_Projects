...
def preprocess_and_save(image_path, output_folder):
    ...
    preprocessed_image = rescale_image(image, fx=scale_x, fy=scale_y, new_width=preprocessed_image_width, new_height=preprocessed_image_height)
    preprocessed_image = reduce_noise(preprocessed_image)
    preprocessed_image = convert_to_grayscale(preprocessed_image)
    preprocessed_image = edge_detection(preprocessed_image)
    ...
    preprocessed_image = image_contours(preprocessed_image, extracted_image=image)
    # preprocessed_image = rotate_image(preprocessed_image)
