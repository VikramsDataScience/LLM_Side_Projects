...
order_products_prior = order_products_prior.groupby('order_id')['reordered'].sum().reset_index()
target_values = order_products_prior.join(merged_products, on='order_id', how='inner', rsuffix='r')
